...
const BlogPostCard: React.FC<BlogPostCardProps> = ({ title, excerpt, image }) => {
  return (
    <div className="bg-white dark:bg-brand-card border border-gray-200 dark:border-brand-border rounded-lg overflow-hidden flex flex-col h-full transition-colors duration-300">
